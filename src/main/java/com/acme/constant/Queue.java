...
//            "   SELECT id FROM temp1 ";
    ...
    String PURCHASE_ORDER_FIND_ALL = "SELECT * FROM public.order_view";
    ...
    String PURCHASE_ORDER_FIND_BY_SUBJECT_ID = "SELECT * FROM public.order_view WHERE recipient_id = ? ";
...
//            "ORDER BY i.date_add asc ";
    ...
    String DELIVERY_GET_ALL = "SELECT * FROM public.delivery";
}
