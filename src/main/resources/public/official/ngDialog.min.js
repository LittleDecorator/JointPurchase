...
!function (a, b) {
    "undefined" != typeof module && module.exports ? ("undefined" == typeof angular ? b(require("angular")) : b(angular), module.exports = "ngDialog") : "function" == typeof define && define.amd ? define(["angular"], b) : b(a.angular)
}(this, function (a) {
    "use strict";
            ...
            var A = [], B = {
                onDocumentKeydown: function (a) {
                    ...
                    if (h) {
                        ...
                        j && j.focus && j.focus(), v.$broadcast("ngDialog.closing", a, b), o = 0 > o ? 0 : o, f && !c.disableAnimation ? (h.$destroy(), a.unbind(g).bind(g, function () {
                    ...
                    a.remove(), 0 === o && (A.html.removeClass("ngdialog-open"), A.body.removeClass("ngdialog-open"), B.resetBodyPadding()), v.$broadcast("ngDialog.closed", a, b)
                ...
                __PRIVATE__: B, open: function (f) {
                    ...
                    if (f = f || {}, !(n && f.name && (j = f.name + " dialog", this.isOpen(j)))) {
                        var q = a.copy(b), D = ++e;
                        j = j || "ngdialog" + D, l.push(j), a.extend(q, f);
                        var E;
                        p[j] = E = t.defer();
                        var F;
                        ...
                        return a.forEach(I, function (b, c) {
                        ...
                        }), t.all({template: h(q.template || q.templateUrl), locals: t.all(I)}).then(function (b) {
                            ...
                            if (q.className && G.addClass(q.className), q.disableAnimation && G.addClass(i), H = q.appendTo && a.isString(q.appendTo) ? a.element(document.querySelector(q.appendTo)) : A.body, B.applyAriaAttributes(G, q), q.preCloseCallback) {
                                var k;
                            ...
                            if (w(function () {
                                    ...
                                    A.html.addClass("ngdialog-open"), A.body.addClass("ngdialog-open");
                            ...
                            if (q.preserveFocus && G.data("$ngDialogPreviousFocus", document.activeElement), d = function (a) {
                                    var b = q.closeByDocument ? c(a.target).hasClass("ngdialog-overlay") : !1, d = c(a.target).hasClass("ngdialog-close");
                    ...
                    d = d || {}, a.extend(f, d), f.scope = a.isObject(f.scope) ? f.scope.$new() : v.$new(), f.scope.confirm = function (a) {
                        e.resolve(a);
                        var b = c(document.getElementById(g.id));
                        B.performCloseDialog(b, a)
                    };
                    var g = C.open(f);
                    return g ? (g.closePromise.then(function (a) {
