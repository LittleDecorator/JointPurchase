!function () {
  ...
  function ClPagingDirective() {
    return {
      restrict: "EA",
      scope: {clPages: "=", clAlign: "@", clAlignModel: "=", clPageChanged: "&", clSteps: "=", clCurrentPage: "="},
      ...
      template: [
        ...
        '<md-button class="md-icon-button md-raised md-warn" aria-label="First" ng-click="vm.gotoFirst()" ng-show="vm.clSteps < clPages"><md-icon class="ng-scope material-icons">first_page</md-icon></md-button>',
        // '<md-button class="md-icon-button md-raised" aria-label="Previous" ng-click="vm.gotoPrev()" ng-show="vm.index - 1 >= 0">&#8230;</md-button>',
        '<md-button class="md-icon-button md-raised" aria-label="Previous" ng-click="vm.gotoPrev()" ng-show="vm.index - 1 >= 0"><md-icon class="ng-scope material-icons">keyboard_arrow_left</md-icon></md-button>',
        ...
        '<md-button class="md-icon-button md-raised" aria-label="Next" ng-click="vm.gotoNext()" ng-show="vm.index + vm.clSteps < clPages"><md-icon class="ng-scope material-icons">keyboard_arrow_right</md-icon></md-button>',
        // '<md-button class="md-icon-button md-raised md-warn" aria-label="Last" ng-click="vm.gotoLast()">{{ vm.last }}</md-button>',
        '<md-button class="md-icon-button md-raised md-warn" aria-label="Last" ng-click="vm.gotoLast()" ng-show="vm.clSteps < clPages"><md-icon class="ng-scope material-icons">last_page</md-icon></md-button>',
        "</div>"
      ].join("")
    }
  }
