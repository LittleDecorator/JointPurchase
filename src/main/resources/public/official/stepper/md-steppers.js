    ...
    function MdSteppers() {
        return {
            ...
            template: function(element, attr) {
                ...
                var ngClick = attr.mdDisableTabsBehavior ? '' : 'ng-click="$mdSteppersCtrl.select(step.getIndex());'+ (angular.isDefined(attr.mdOnSelect) ? ' $mdSteppersCtrl.onSelect()' : "") +'" ';
                //var ngClick = attr.mdDisableTabsBehavior ? '' : 'ng-click="$mdSteppersCtrl.select(step.getIndex());" ';
