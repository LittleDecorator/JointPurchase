	...
	a.fn.scrollTo = function (b) {
		...
		this.each(function () {
			...
			function e() {
				...
				i.css({position: "absolute", top: g.position().top + b, left: leftPosition}), i.stop(!0, !0).css("opacity", 0).slideDown({
					queue: !1,
			...
			return this.each(function () {
				...
				if (b.is(":visible") && (j.css({right: f - (i + 1) * g}), j.css({left: i * g})), a(window).resize(function () {
							...
							i = e.index(a(this)), 0 > i && (i = 0), d.show(), i - k >= 0 ? (j.velocity({right: f - (i + 1) * g}, {
								...
								queue: !1,
								easing: "easeOutQuad"
							}), j.velocity({right: f - (i + 1) * g}, {duration: 300, queue: !1, easing: "easeOutQuad", delay: 90})), h.preventDefault()
						}), h >= g) {
		...
		return "remove" === c ? (this.each(function () {
			...
			l.appendTo(k), l.css({top: 0, left: 0}), i.off("mouseenter.tooltip mouseleave.tooltip"), i.on({
				"mouseenter.tooltip": function (a) {
					...
					h = void 0 === h || "" === h ? c.delay : h, d = 0, f = setInterval(function () {
						if (d += 10, d >= h && e === !1) {
							...
							"top" === n ? (a = i.offset().top - o - g, c = i.offset().left + j / 2 - p / 2, f = b(c, a, p, o), q = "-10px", l.css({
								...
								delay: 50,
								queue: !1
							}), l.css({display: "block"}).velocity({opacity: 1}, {duration: 55, delay: 0, queue: !1}).velocity({scale: s}, {
								duration: 300,
								delay: 0,
								queue: !1,
					...
					clearInterval(f), d = 0, k.velocity({opacity: 0, marginTop: 0, marginLeft: 0}, {duration: 225, queue: !1, delay: 225}), l.velocity({
						opacity: 0,
						scale: 1
					}, {
