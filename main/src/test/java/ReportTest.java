...
public class ReportTest {
    ...
    private JasperReportBuilder buidReport() throws DRException {
        ...
        //add columns
        TextColumnBuilder<String> name = column("Name", "comment", type.stringType()).setStyle(columnBorder).setWidth(mm(30));
...
//        TextColumnBuilder<BigDecimal> totalPayment = payment.multiply(1).setTitle("Total payment").setDataType(type.bigDecimalType());
    ...
    public void exportReport() throws DRException, FileNotFoundException {
        buidReport().toPdf(new FileOutputStream(new File("C:/data/test2.pdf")));
    }
    ...
    private JRDataSource getData(){
        if(orderMapper!=null){
            ...
            order1.setComment("test purchase");
            order1.setSubjectId("d7651309-e8f4-47d5-a5a7-e4930456eae9");
            order1.setPayment(new BigDecimal(350));
            PurchaseOrder order2 = new PurchaseOrder();
            order2.setId("ad7d2c80-fb59-4968-9862-a10282a5477d");
            order2.setComment("another test purchase");
            order2.setSubjectId("d7651309-e8f4-47d5-a5a7-e4930456eae9");
...
//        new ReportTest().showReport();
        new ReportTest().exportReport();
    }
}
