/*
(function (angular) {
    angular.module("ui.materialize", ["ui.materialize.ngModel", "ui.materialize.collapsible", "ui.materialize.toast",
                                      "ui.materialize.sidenav", "ui.materialize.material_select", "ui.materialize.dropdown",
                                      "ui.materialize.inputfield", "ui.materialize.input_date", "ui.materialize.tabs",/!* "ui.materialize.pagination",*!/
                                      "ui.materialize.pushpin", "ui.materialize.parallax","ui.materialize.modal", "ui.materialize.tooltipped"]);
    ...
    angular.module("ui.materialize.sidenav", [])
        .directive("sidenav", [function () {
            return {
                ...
                link: function (scope, element, attrs) {
                    console.log("in sidenav directive");
                    element.sideNav({
...
/!*    angular.module("ui.materialize.material_select", [])
        .directive("materialSelect", function ($compile, $timeout) {
            return {
                link: function (scope, element, attrs) {
                    console.log(element);
